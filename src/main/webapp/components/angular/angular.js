 ...
 *
 * - your app is hosted at url `http://tvshows.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://tvshows.example.com/clickThru?...`.
 *
 ...
 *      'http://tvshows.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
